...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_BSLS), \
         ...
         KC_FN1, KC_FN5, KC_LGUI, KC_FN4, KC_BSPC, KC_LCTL, KC_LALT, \
  ...
  KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP,     KC_UP, KC_F7, KC_F8, KC_F9, KC_F10, \
         ...
         KC_MPLY, KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU, KC_FN3, KC_F1, KC_F2, KC_F3, KC_F12, \
  ...
  KEYMAP(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
         ...
         KC_NO, KC_FN5, KC_LGUI, KC_FN4, KC_BSPC,    KC_LCTL, KC_LALT,   KC_SPC, KC_FN2, KC_NO, KC_NO, KC_ENT),
};
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [4] = ACTION_LAYER_MOMENTARY(2),  // to second Fn overlay (function keys)
  [5] = ACTION_LAYER_MOMENTARY(3),  // to third Fn overlay (vi keys)
};
